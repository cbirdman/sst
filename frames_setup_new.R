...
for(i in c("hp1","hp2","hp3","hp4","hp5","ap1","ap2","ap3","ap4","ap5")){
    frames[,d1:=pdist(frames[[paste0(i,"_x")]],ifelse(grepl("h",i),ap1_x,hp1_x),
                      frames[[paste0(i,"_y")]],ifelse(grepl("h",i),ap1_y,hp1_y))]
    frames[,d2:=pdist(frames[[paste0(i,"_x")]],ifelse(grepl("h",i),ap2_x,hp2_x),
                      frames[[paste0(i,"_y")]],ifelse(grepl("h",i),ap2_y,hp2_y))]
    frames[,d3:=pdist(frames[[paste0(i,"_x")]],ifelse(grepl("h",i),ap3_x,hp3_x),
                      frames[[paste0(i,"_y")]],ifelse(grepl("h",i),ap3_y,hp3_y))]
    frames[,d4:=pdist(frames[[paste0(i,"_x")]],ifelse(grepl("h",i),ap4_x,hp4_x),
                      frames[[paste0(i,"_y")]],ifelse(grepl("h",i),ap4_y,hp4_y))]
    frames[,d5:=pdist(frames[[paste0(i,"_x")]],ifelse(grepl("h",i),ap5_x,hp5_x),
                      frames[[paste0(i,"_y")]],ifelse(grepl("h",i),ap5_y,hp5_y))]
    frames[,(gsub("p","d",i)):=
      ...
      ifelse(d5==pmin(d1,d2,d3,d4,d5),ifelse(grepl("h",i),ap5,hp5),NA)))))]
}
...
# frames[,bh:=ifelse(idx==1,0,ifelse(!event%in%c("ORB","DRB","DRIB","POSS"),0,
